...
export const RU: Record<string, string> = {
    ...
    'class.exo_marine.bonus': 'Броня +4 · +1% макс. HP за уровень',
    'class.astro_biologist.name': 'Астробиолог',
    'class.astro_biologist.bonus': 'Реген 0.5%/с от недостающего HP, Площадь +10% · +1% площади за уровень',
    ...
    'class.null_warden.bonus': 'Площадь +15%, Броня +2 · +1% длительности эффектов за уровень',
    'class.berserker.name': 'Берсерк',
    'class.berserker.bonus': 'HP +50%, Урон +10%, Броня −4 · Адреналин: сильнее и быстрее ниже 35% HP · +1% шанса крита за уровень',
