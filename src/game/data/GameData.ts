...
export const POWERUPS: PowerupData[] = [
    ...
    { id: 'kill_echo', name: "Kill Echo", description: "The dead sometimes detonate, tearing a chunk out of everything nearby and setting it alight", type: "killEcho", value: 0.1, maxStacks: 3, emoji: "☠️" },
